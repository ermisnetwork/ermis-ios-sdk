...
open class ErmisAudioPlayer: AudioPlaying, AppStateObserverDelegate {
    // MARK: - Properties
    ...
    /// An observer that acts as a mediator between the AVPlayer and ErmisAudioPlayer for playback
    /// updates.
    ...
    public required convenience init() {
        self.init(
            assetPropertyLoader: ErmisAssetPropertyLoader(),
            playerObserver: ErmisPlayerObserver(),
            player: .init(),
            audioSessionConfigurator: ErmisAudioSessionConfigurator(),
            appStateObserver: ErmisAppStateObserver()
        )
    }
