...
protocol AudioAnalysing {
    /// Analyse and process the provided context and provide data points limited to the number of the targetSamples.
    /// - Parameters:
...
final class ErmisAudioWaveformAnalyser: AudioAnalysing {
