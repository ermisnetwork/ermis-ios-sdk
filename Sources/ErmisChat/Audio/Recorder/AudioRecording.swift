...
open class ErmisAudioRecorder: NSObject, AudioRecording, AVAudioRecorderDelegate, AppStateObserverDelegate {
    ...
    public struct Configuration {
        ...
        /// The default Configuration that is being bused by `ErmisAudioRecorder`
    ...
    /// Initialises a new instance of ErmisAudioRecorder
    /// - Parameters:
