...
extension Notification.Name {
    ...
    static let internetConnectionStatusDidChange = Self("network.ermis.ermisChat.internetConnectionStatus")

    /// Posted only when the Internet connection availability is changed (excluding quality updates).
    static let internetConnectionAvailabilityDidChange = Self("network.ermis.ermisChat.internetConnectionAvailability")
}
...
extension InternetConnection {
    class Monitor: InternetConnectionMonitor {
        ...
        private let queue = DispatchQueue(label: "network.ermis.internet-monitor")
