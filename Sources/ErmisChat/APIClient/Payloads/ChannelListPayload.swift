...
extension ChannelPayload: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            messages: try container.decodeArrayIfPresentIgnoringFailures([MessagePayload].self, forKey: .messages) ?? [],
...
extension ChannelDetailPayload: Decodable {
    init(from decoder: Decoder) throws {
        ...
        self.init(
            ...
            saveMessage: try container.decodeIfPresent(Bool.self, forKey: .saveMessage),
            ...
            memberCapabilities: try container.decodeIfPresent([String].self, forKey: .memberCapabilities),
            filterWords: try container.decodeIfPresent([String].self, forKey: .filterWords),
...
struct ChannelReadPayload: Decodable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        self.lastReadMessageId = try container.decodeIfPresent(MessageId.self, forKey: .lastReadMessageId)
...
public class ChannelConfig: Codable {
    private enum CodingKeys: String, CodingKey {
        case reactionsEnabled = "send-reaction"
    ...
    /// Enable pin message. Enable by default.
    ...
    public required init(from decoder: Decoder) throws {
        ...
        pinEnabled = try container.decode(Bool.self, forKey: .pinEnabled)
