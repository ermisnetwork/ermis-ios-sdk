...
///
/// The `MessageLinkAttachment` attachment will be added to the message automatically
/// if the message is sent with the text containing the URL.
public typealias MessageLinkAttachment = MessageAttachment<LinkAttachmentPayload>
