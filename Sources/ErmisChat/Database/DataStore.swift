...
public struct DataStore {
    ...
    public func user(id: UserId, projectId: String) -> ChatUser? {
        try? database.viewContext.user(id: id, projectId: projectId)?.asModel()
    }
    ...
    /// model object. If a user object doesn't exist locally, returns `nil`.
    public func currentUser(of projectId: String) -> CurrentChatUser? {
        try? database.viewContext.currentUser?.asModel(projectId)
    }
    ...
    public func channel(cid: ChannelId) -> Channel? {
