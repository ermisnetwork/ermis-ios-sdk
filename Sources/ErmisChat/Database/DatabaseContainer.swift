...
class DatabaseContainer: NSPersistentContainer {
    ...
    private let localCachingSettings: ErmisClientConfig.LocalCaching?
    private let deletedMessageVisibility: ErmisClientConfig.DeletedMessageVisibility?
    ...
    init(
        ...
        modelName: String = "ErmisChatModel",
        bundle: Bundle? = .ermisChat,
        localCachingSettings: ErmisClientConfig.LocalCaching? = nil,
        deletedMessagesVisibility: ErmisClientConfig.DeletedMessageVisibility? = nil,
    ...
    private func setupLoggerForDatabaseChanges() {
        loggerNotificationObserver = NotificationCenter.default
            .addObserver(
                ...
                log.debug("Data saved to DB: \(String(describing: $0.userInfo?.count))", subsystems: .database)
            }
    }
