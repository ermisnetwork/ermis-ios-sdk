...
extension ChannelListController {
    ...
    public class ObservableObject: SwiftUI.ObservableObject {
        ...
        public let controller: ChannelListController

        /// The channels matching the query.
        @Published public private(set) var channels: LazyCachedMapCollection<Channel> = []
...
extension ChannelListController.ObservableObject: ChannelListControllerDelegate {
