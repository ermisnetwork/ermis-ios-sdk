...
public extension ErmisClient {
    ...
    /// Creates a `ChannelController` that will create a new channel, if the channel doesn't exist already.
    ///
    ...
    /// Creates a `ChannelController` that will create a new channel with the provided members without having to specify
