...
extension ConnectionStatus {
    // In internal initializer used for convering internal `WebSocketConnectionState` to `ErmisClientConnectionStatus`.
...
enum WebSocketConnectionState: Equatable {
    ...
    var isAutomaticReconnectionEnabled: Bool {
        ...
        case let .serverInitiated(clientError):
            ...
            if let serverInitiatedError = clientError?.underlyingError as? ErmisApiError {
