...
/// A ViewController that manages all aspects of the voice recording from the ComposerViewController.
///
/// The VoiceRecordingViewController even though it's a ViewController (as it manages a view) it doesn't
...
open class VoiceRecordingViewController: _ViewController, ComponentsProvider, ThemeProvider, AudioRecordingDelegate, AudioPlayingDelegate, UIGestureRecognizerDelegate {
    // MARK: - Nested Types
    ...
    public struct Content: Equatable {
        ...
        /// The content the VoiceRecordingViewController will have when is `idle` (no active recording or in preview.)
        ...
        /// The content the VoiceRecordingViewController will have when we have an unlocked active recording.
    ...
    /// The delegate which the `VoiceRecordingViewController` will ask for support on presenting views and
    ...
    open lazy var audioAnalysisFactory: AudioAnalysisEngine? = try? .init(
        assetPropertiesLoader: ErmisAssetPropertyLoader()
    )
    ...
    override open func setUp() {
        ...
        stopRecordingButton.setImage(theme.icons.stop, for: .normal)
        stopRecordingButton.tintColor = theme.colors.error
...
/// A delegate that the VoiceRecordingViewController will use to post information or ask for support.
public protocol VoiceRecordingDelegate: AnyObject {
    /// Creates and attaches a VoiceRecording attachment on the message.
    /// - Parameters:
    ///   - voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    ...
    /// Informs the delegate that the VoiceRecordingViewController wants to publish the current message.
    /// - Parameter voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    func voiceRecordingPublishMessage(_ voiceRecordingVC: VoiceRecordingViewController)

    /// Informs the delegate that the VoiceRecordingViewController will begin recording.
    /// - Parameter voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    func voiceRecordingWillBeginRecording(_ voiceRecordingVC: VoiceRecordingViewController)

    /// /// Informs the delegate that the VoiceRecordingViewController did begin recording.
    /// - Parameter voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    func voiceRecordingDidBeginRecording(_ voiceRecordingVC: VoiceRecordingViewController)

    /// Informs the delegate that the VoiceRecordingViewController did lock the recording UI.
    /// - Parameter voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    func voiceRecordingDidLockRecording(_ voiceRecordingVC: VoiceRecordingViewController)

    /// Informs the delegate that the VoiceRecordingViewController did stop recording.
    /// - Parameter voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    func voiceRecordingDidStopRecording(_ voiceRecordingVC: VoiceRecordingViewController)

    /// Informs the delegate that the VoiceRecordingViewController wants to present a floatingView outside of its
    /// viewport.
    /// - Parameters:
    ///   - voiceRecordingVC: The VoiceRecordingViewController responsible for this action.
    ///   - floatingView: The view that the VoiceRecordingViewController wants to present outside of its viewport.
    func voiceRecording(_ voiceRecordingVC: VoiceRecordingViewController, presentFloatingView floatingView: UIView)
}
