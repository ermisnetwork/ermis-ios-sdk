...
public
class InvitedChannelCollectionViewCell: _CollectionViewCell, UIProvider {
    /// The `ChannelListItemView` instance used as content view.
    open private(set) lazy var itemView: InvitedChannelListItemView = components
        .invitedChannelContentView
        .init()
