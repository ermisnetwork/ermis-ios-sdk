...
open class ChannelListCollectionViewCell: _CollectionViewCell,
                                          UIProvider {
    /// The `ChannelListItemView` instance used as content view.
    open private(set) lazy var itemView: ChannelListItemView = components
        .channelListItemContentView
        .init()
