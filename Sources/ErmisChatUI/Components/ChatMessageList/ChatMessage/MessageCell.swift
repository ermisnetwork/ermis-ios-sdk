...
public class MessageCell: _TableViewCell, UIProvider {
    ...
    public private(set) var messageContentView: MessageContentView?
    ...
    public func setDecoration(
        for decorationType: MessageDecorationType,
        decorationView: MessageCellHeaderFooterView?
    ) {
    ...
    public func setMessageContentIfNeeded(
        ...
        messageContentView!.setUpUIIfNeeded(
            options: options,
    ...
    private func updateSpacingBetween() {
        if let headerDecorationView = headerContainerView.subviews.first as? MessageCellHeaderFooterView {
            setDecoration(for: .header, decorationView: headerDecorationView)
        }

        if let footerDecorationView = footerContainerView.subviews.first as? MessageCellHeaderFooterView {
