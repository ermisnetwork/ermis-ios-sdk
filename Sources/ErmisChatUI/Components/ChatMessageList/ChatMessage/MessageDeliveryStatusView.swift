...
open class MessageDeliveryStatusView: _Control, UIProvider {
    ...
    open private(set) lazy var messageDeliveryChekmarkView: MessageDeliveryStatusCheckmarkView = components
    ...
    override open func setUpTheme() {
        ...
        messageReadСountsLabel.textColor = theme.colors.primary
        messageReadСountsLabel.font = theme.fonts.footnote.bold
    }
    ...
    override open func contentDidChanged() {
        ...
        messageReadСountsLabel.text = content.flatMap {
            guard
                // Only show for group, not show message label in direct channel
                !$0.channel.isDirectMessageChannel,
