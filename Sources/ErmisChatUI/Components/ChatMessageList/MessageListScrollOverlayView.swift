...
/// A protocol for `MessageListScrollOverlayView` data source.
public protocol MessageListScrollOverlayDataSource: AnyObject {
    ...
    func scrollOverlay(_ overlay: MessageListScrollOverlayView, textForItemAt indexPath: IndexPath) -> String?
}

/// View that is displayed as top overlay when message list is scrolling
open class MessageListScrollOverlayView: _View, UIProvider {
    ...
    open lazy var dateSeparatorView: MessageListDateSeparatorView = components
        .messageListDateSeparatorView.init()
        .withoutAutoresizingMaskConstraints

    /// The data source used to get the content to display.
    public weak var dataSource: MessageListScrollOverlayDataSource?
