...
open class UploadingOverlayView: _View, UIProvider {
    ...
    public private(set) lazy var loadingIndicator: LoadingIndicator = components
...
extension Theme {
    func fileAttachmentActionIcon(for state: LocalAttachmentState) -> UIImage? {
        icons.fileAttachmentActionIcons[state]
    }
}
