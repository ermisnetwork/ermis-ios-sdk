...
open class MessageReactionAuthorsViewController: _ViewController,
                                                 UIProvider,
    ...
    open lazy var flowLayout: UICollectionViewFlowLayout = MessageReactionAuthorsFlowLayout()
    ...
    open var content: [MessageReaction] {
        messageController.reactions.filter { theme.icons.availableReactions[$0.type] != nil }
    }
    ...
    override open func setUpTheme() {
        ...
        topLabel.font = theme.fonts.title3
        topLabel.textColor = theme.colors.text
    ...
    open func collectionView(
        ...
        cell.content = MessageReactionAuthorViewCell.Content(
            reaction: reaction,
