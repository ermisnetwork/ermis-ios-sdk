...
/// `MessagePopupViewController` is shown when user long-presses a message.
...
open class MessagePopupViewController: _ViewController, ComponentsProvider {
    ...
    /// `MessageActionsViewController` instance for showing actions.
    public var actionsController: MessageActionsViewController?

    /// `MessageReactionsPickerViewController` instance for showing reactions.
    public var reactionsController: MessageReactionsPickerViewController?

    /// `MessageReactionAuthorsViewController` instance for showing the authors of the reactions.
    public var reactionAuthorsController: MessageReactionAuthorsViewController?
