...
/// The view of the `TopicListLoadingViewCell`, which contains the UI elements being animated with a shimmer.
open class TopicListLoadingViewCellContentView: _View, UIProvider, SkeletonLoadable {
