...
open class MessageListRouter:
    ...
    ComponentsProvider
{
    /// The transition controller used to animate `MessagePopupViewController` transition.
    open private(set) lazy var messagePopUpTransitionController: MessageActionsTransitionController = components
        ...
        .init(messageListVC: rootViewController as? MessageListViewController)
    ...
    ///   - messageActionsController: The `MessageActionsViewController` object which will presented as a part of the pop up.
    ///   - messageReactionsController: The `MessageReactionsPickerViewController` object which will presented as a part of the pop up.
    open func showMessageActionsPopUp(
        messageContentView: MessageContentView,
        messageActionsController: MessageActionsViewController,
        messageReactionsController: MessageReactionsPickerViewController?
    ) {
    ...
    ///   - client: The current `ErmisClient` instance.
    ...
    open func showUser(_ user: ChatUser) {
        log.info(
            ...
            To provide your own profile view, please override MessageListRouter.showUser()"
            """
        )
    }
