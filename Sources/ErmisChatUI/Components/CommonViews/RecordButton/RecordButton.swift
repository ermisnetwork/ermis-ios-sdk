...
open class RecordButton: _Button, ThemeProvider, ComponentsProvider {
    ...
    override open func setUpTheme() {
        ...
        setImage(
            theme.icons.mic.tinted(with: theme.colors.text),
            for: .normal
        )
        setImage(
            theme.icons.mic.tinted(with: theme.colors.primary),
            for: .highlighted
        )
    }
