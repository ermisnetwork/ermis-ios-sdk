...
/// Custom transitioning delegate to handle a modal presentation.
///
/// This should be used if you are presenting the ``ChannelViewController`` in a modal.
...
open class ModalTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    public func presentationController(
        ...
        ErmisModalPresentationController(presentedViewController: presented, presenting: presenting)
    }
}

/// Custom `UIPresentationController` to handle a modal presentation.
open class ErmisModalPresentationController: UIPresentationController {
